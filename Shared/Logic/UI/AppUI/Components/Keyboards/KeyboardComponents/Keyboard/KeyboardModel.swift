...
final class KeyboardModel: Identifiable, ObservableObject {
    ...
    private(set) var shouldShowSettingsButton: Bool = true
    @Published private(set) var mode: KeyboardMode = OSHelper.runtimeEnvironment == .macOS ? .qwerty : .letters
    ...
    init(requiresNextKeyboardButton: Bool,
        ...
        self.shouldShowSettingsButton = shouldShowSettingsButton
    }
...
extension KeyboardModel {
    func mapKeyToKeyboardMode(_ key: Key) -> KeyboardMode? {
        if OSHelper.runtimeEnvironment == .macOS { return .qwerty }
...
extension KeyboardModel {
    func getKeyboardCharacters(forMode mode: KeyboardMode? = nil) -> KeyboardCharacterSet {
        ...
        switch(getMode) {
            case .qwerty: return qwertyCharacters
    ...
    fileprivate var letterCharacters: KeyboardCharacterSet {
        ...
        return [
            ...
            [bottomGroup, [.space], shouldShowSettingsButton
                ? [.return, .settings]
                : [.return]]
        ]
    }
    ...
    fileprivate var qwertyCharacters: KeyboardCharacterSet {
        [
            [[.tilda, .one, .two, .three, .four, .five, .six, .seven, .eight, .nine, .zero, .minus, .equal, .delete]],
            [[.tab], [.q, .w, .e, .r, .t, .y, .u, .i, .o, .p, .leftBracket, .rightBracket], [.backslash]],
            [[.capsLock], [.a, .s, .d, .f, .g, .h, .j, .k, .l, .semicolon, .quote], [.return]],
            [[.shift], [.z, .x, .c, .v, .b, .n, .m, .comma, .period, .slash], [.rightShift]],
            [[.function, .control, .option, .command], [.space], [.rightCommand, .rightOption, .rightControl]]
        ]
    }
}
